...
public class MedicoController {
    ...
    @PostMapping()
    @Transactional
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroMedico dados, UriComponentsBuilder uriBuilder){ // precisa retornar (201 created + os dados que foram cadastrados + cabeçalho location)
    ...
    @PutMapping
    @Transactional
    public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizacaomMedico dados){
